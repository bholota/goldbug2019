...
interface IOpenVPNAPIService {
	 ...
	 * if this return null OSE Bezpieczny internet already has the permissions otherwise you can start the returned Intent
	 * to let OSE Bezpieczny internet request the permission */
	...
	/** Request a socket to be protected as a VPN socket would be. Useful for creating
	  ...
	  * Before calling this function you should make sure OSE Bezpieczny internet may actually
