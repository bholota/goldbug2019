...
tasks.register < Exec > ("generateOpenVPN3Swig") {
  ...
  if (File("/usr/local/bin/swig").exists()) swigcmd = "/usr/local/bin/swig"

  doFirst {
    mkdir(openvpn3SwigFiles)
  }
  commandLine(
      listOf(swigcmd, "-outdir", openvpn3SwigFiles, "-outcurrentdir", "-c++", "-java", "-package",
          "net.openvpn.ovpn3",
          "-Isrc/main/cpp/openvpn3/client", "-Isrc/main/cpp/openvpn3/",
          "-o", "${openvpn3SwigFiles}/ovpncli_wrap.cxx", "-oh",
...
android {
  ...
  lintOptions {
    enable("BackButton", "EasterEgg", "StopShip", "IconExpectedSize", "GradleDynamicVersion",
...
if (project.hasProperty("keystoreFile") && project.hasProperty("keystorePassword") &&
...
dependencies {
  ...
  dependencies.add("uiImplementation", "com.github.ngallazzi:FancySwitch:master-SNAPSHOT")
  dependencies.add("uiImplementation", "com.bitvale:switcher:1.0.5")
