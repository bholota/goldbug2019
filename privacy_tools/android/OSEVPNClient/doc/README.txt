...
understand the licenses of the code. OSE Bezpieczny internet is GPL-licensed. You
_CANNOT_ build a closed sourced custom UI application without acquiring a different
(paid) license for UI code.

The use of the AIDL API to control OSE Bezpieczny internet from an external app is
...
A: OSE Bezpieczny internet uses a OpenVPN  master branch + dual stack
